        ...
        <div class="card">
            ...
            <ul class="list-group">
              ...
              <li class="list-group-item">
                <div class="row">
                  ...
                  <div class="col-12 col-md-10">{{ $country->countries_title }}</div>
                </div>
              </li>
              ...
              <li class="list-group-item">
                <div class="row">
                  ...
                  <div class="col-12 col-md-10">{{ __('admin::lang.'. $country->countries_status) }}</div>
                </div>
              </li>
            </ul>
          </div>
          <div class="card-footer">
            ...
            @can('update countries')
              <a href="{{ route('admin.countries.edit', $country->countries_id) }}" class="btn btn-sm btn-warning">
