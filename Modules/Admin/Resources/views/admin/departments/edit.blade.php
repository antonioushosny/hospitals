    ...
    <div class="container-fluid">
      <div class="animated fadeIn">
        <div class="card">
          ...
          <form class="form-horizontal" action="{{ route('admin.departments.update', $department->departments_id) }}" method="post" enctype="multipart/form-data">
          	@csrf
          	@method('PUT')
          	@include('admin::admin.departments.form')
