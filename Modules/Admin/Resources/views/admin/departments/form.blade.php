                ...
                <div class="col-lg-9">
                  ...
                  <div class="form-group row"  id="{{ $lang->locale }}-departments_title" >
                    ...
                    <div class="col-md-9">
                      ...
                      <input class="form-control {{ $errors->first($lang->locale .'.departments_title') ? 'is-invalid' : '' }}" id="{{ $lang->locale .'[departments_title]' }}" type="text" name="{{ $lang->locale .'[departments_title]' }}" placeholder="{{ __('admin::lang.departments_title') }}">
