  ...
  <main class="main">
    ...
    <ol class="breadcrumb">
		<li class="breadcrumb-item">  <a href="{{ route('admin.dashboard.home') }}">{{ __('admin::lang.home') }} </a></li>
       	<li class="breadcrumb-item  active"> {{ __('admin::lang.doctors') }} </li>
    </ol>
    ...
    <div class="container-fluid">
      <div class="animated fadeIn">
        ...
        <div class="card">
          <div class="card-body">
            <form class="form-horizontal" action="{{ route('admin.doctors.index') }}" method="get">
              <div class="row">
                <div class="form-group col-12 col-md-1 text-center">
                	@can('create doctors')
	                	<a href="{{ route('admin.doctors.create') }}" class="btn btn-success btn-sm"><i class="fa fa-plus"></i></a>
                	@endcan
                </div>
        ...
        <div class="card d-none d-md-block">
          <div class="card-header">
          	<div class="row">
          		<div class="col-12 col-md-1 text-center"><strong>{{ __('admin::lang.name') }}</strong></div>
          		...
          		<div class="col-12 col-md-1 text-center"><strong>{{ __('admin::lang.country') }}</strong></div>
          		<div class="col-12 col-md-1 text-center"><strong>{{ __('admin::lang.hospital') }}</strong></div>
          		<div class="col-12 col-md-1 text-center"><strong>{{ __('admin::lang.department') }}</strong></div>
	          	...
	          	<div class="row">
	          		...
	          		<div class="col-12 col-md-1 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				...
	          				<div class="col-8 col-md-12">{{ $doctor->doctors_name }}</div>
	          			</div>
	          		</div>
	          		...
	          		<div class="col-12 col-md-1 text-md-center">
	          			<div class="row mb-2 mb-md-0">
							  ...
							  <div class="col-8 col-md-12">{{ $doctor->doctors_phone }}</div>
	          			</div>
	          		</div>
					<div class="col-12 col-md-2 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				<div class="col-4 d-block d-md-none"><strong>{{ __('admin::lang.email') }}</strong></div>
	          				<div class="col-8 col-md-12">{{ $doctor->doctors_email }}</div>
	          			</div>
	          		</div>
					<div class="col-12 col-md-2 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				<div class="col-4 d-block d-md-none"><strong>{{ __('admin::lang.civil_no') }}</strong></div>
	          				<div class="col-8 col-md-12">{{ $doctor->doctors_civil_no }}</div>
	          			</div>
	          		</div>
					...
					<div class="col-12 col-md-1 text-md-center">
	          			<div class="row mb-2 mb-md-0">
							  ...
							  <div class="col-8 col-md-12">{{ $doctor->country ?  $doctor->country->countries_title : '' }}</div>
	          			</div>
	          		</div>
					<div class="col-12 col-md-1 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				<div class="col-4 d-block d-md-none"><strong>{{ __('admin::lang.hospital') }}</strong></div>
							  <div class="col-8 col-md-12">{{ $doctor->hospital ?  $doctor->hospital->hospitals_title : '' }}</div>
	          			</div>
	          		</div>
					<div class="col-12 col-md-1 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				<div class="col-4 d-block d-md-none"><strong>{{ __('admin::lang.department') }}</strong></div>
							  <div class="col-8 col-md-12">{{ $doctor->department ?  $doctor->department->departments_title : '' }}</div>
	          			</div>
	          		</div>
					<div class="col-12 col-md-1 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				<div class="col-4 d-block d-md-none"><strong>{{ __('admin::lang.specialty') }}</strong></div>
							  <div class="col-8 col-md-12">{{ $doctor->specialty ?  $doctor->specialty->specialties_title : '' }}</div>
	          			</div>
	          		</div>
	          		<div class="col-12 col-md-1 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				...
	          				<div class="col-8 col-md-12">
	          					@if ($doctor->doctors_status == 'active')
	          		...
	          		<div class="col-12 col-md-1 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				...
	          				<div class="col-8 col-md-12">
	          					<form method="POST" action="{{ route('admin.doctors.destroy', $doctor->doctors_id) }}">
	          						@csrf
	          						@method('DELETE')
	          						@can('view doctors')
			          					<a href="{{ route('admin.doctors.show', $doctor->doctors_id) }}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>
	          						@endcan
	          						@can('update doctors')
			          					<a href="{{ route('admin.doctors.edit', $doctor->doctors_id) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
	          						@endcan
	          						@can('delete doctors')
