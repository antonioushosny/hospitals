  ...
  <main class="main">
    ...
    <ol class="breadcrumb">
		<li class="breadcrumb-item">  <a href="{{ route('admin.dashboard.home') }}">{{ __('admin::lang.home') }} </a></li>
       	<li class="breadcrumb-item  active"> {{ __('admin::lang.specialties') }} </li>
    </ol>
    ...
    <div class="container-fluid">
      <div class="animated fadeIn">
        ...
        <div class="card">
          <div class="card-body">
            <form class="form-horizontal" action="{{ route('admin.specialties.index') }}" method="get">
              <div class="row">
                <div class="form-group col-12 col-md-1 text-center">
                	@can('create specialties')
	                	<a href="{{ route('admin.specialties.create') }}" class="btn btn-success btn-sm"><i class="fa fa-plus"></i></a>
                	@endcan
                </div>
	          	...
	          	<div class="row">
	          		<div class="col-xs-12 col-md-2 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				...
	          				<div class="col-8 col-md-12">{{ $specialty->specialties_id }}</div>
	          			</div>
	          		</div>
	          		<div class="col-12 col-md-4 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				<div class="col-4 d-block d-md-none"><strong>{{ __('admin::lang.title') }}</strong></div>
	          				<div class="col-8 col-md-12">{{ $specialty->specialties_title }}</div>
	          			</div>
	          		</div>
	          		...
	          		<div class="col-12 col-md-3 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				...
	          				<div class="col-8 col-md-12">
	          					@if ($specialty->specialties_status == 'active')
	          		...
	          		<div class="col-12 col-md-3 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				...
	          				<div class="col-8 col-md-12">
	          					<form method="POST" action="{{ route('admin.specialties.destroy', $specialty->specialties_id) }}">
	          						@csrf
	          						@method('DELETE')
	          						@can('view specialties')
			          					<a href="{{ route('admin.specialties.show', $specialty->specialties_id) }}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>
	          						@endcan
	          						@can('update specialties')
			          					<a href="{{ route('admin.specialties.edit', $specialty->specialties_id) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
	          						@endcan
		...
		@endforelse
				...
				{{ $specialties->appends(request()->except('page'))->links() }}
      </div>
    </div>
  </main>
@endsection
