        ...
        <div class="card">
            ...
            <ul class="list-group">
              <li class="list-group-item">
                <div class="row">
                  ...
                  <div class="col-12 col-md-10">{{ $specialty->specialties_id }}</div>
                </div>
              </li>
              <li class="list-group-item">
                <div class="row">
                  <div class="col-12 col-md-2"><strong>{{ __('admin::lang.title') }}</strong></div>
                  <div class="col-12 col-md-10">{{ $specialty->specialties_title }}</div>
                </div>
              </li>
              ...
              <li class="list-group-item">
                <div class="row">
                  ...
                  <div class="col-12 col-md-10">{{ __('admin::lang.'. $specialty->specialties_status) }}</div>
                </div>
              </li>
            </ul>
          </div>
          <div class="card-footer">
            ...
            @can('update specialties')
              <a href="{{ route('admin.specialties.edit', $specialty->specialties_id) }}" class="btn btn-sm btn-warning">
