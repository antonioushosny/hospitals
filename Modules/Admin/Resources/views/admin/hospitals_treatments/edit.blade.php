    ...
    <div class="container-fluid">
      <div class="animated fadeIn">
        <div class="card">
          ...
          <form class="form-horizontal" action="{{ route('admin.hospitals_treatments.update', $hospitals_treatment->hospitals_treatments_id) }}" method="post" enctype="multipart/form-data">
          	@csrf
          	@method('PUT')
          	@include('admin::admin.hospitals_treatments.form')
