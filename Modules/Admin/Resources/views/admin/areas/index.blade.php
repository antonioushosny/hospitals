  ...
  <main class="main">
    ...
    <ol class="breadcrumb">
		<li class="breadcrumb-item">  <a href="{{ route('admin.dashboard.home') }}">{{ __('admin::lang.home') }} </a></li>
       	<li class="breadcrumb-item  active"> {{ __('admin::lang.areas') }} </li>
    </ol>
    ...
    <div class="container-fluid">
      <div class="animated fadeIn">
        ...
        <div class="card">
          <div class="card-body">
            <form class="form-horizontal" action="{{ route('admin.areas.index') }}" method="get">
              <div class="row">
                <div class="form-group col-12 col-md-1 text-center">
                	@can('create areas')
	                	<a href="{{ route('admin.areas.create') }}" class="btn btn-success btn-sm"><i class="fa fa-plus"></i></a>
                	@endcan
                </div>
			 
				<div class="form-group col-12 col-md-3 text-center">
					{{ Form::select('city',$cities,old('city'),['placeholder'=> __('admin::lang.city'),'class'=>'select2 form-control'])}}    
                </div>
        ...
        <div class="card d-none d-md-block">
          <div class="card-header">
          	<div class="row">
          		...
          		<div class="col-12 col-md-3 text-center"><strong>{{ __('admin::lang.city') }}</strong></div>
          		...
          		<div class="col-12 col-md-2 "><strong>{{ __('admin::lang.actions') }}</strong></div>
          	</div>
          </div>
        </div>
	          	...
	          	<div class="row">
	          		<div class="col-xs-12 col-md-1 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				...
	          				<div class="col-8 col-md-12">{{ $area->areas_id }}</div>
	          			</div>
	          		</div>
					...
					<div class="col-12 col-md-3 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				...
	          				<div class="col-8 col-md-12">{{ $area->city ? $area->city->cities_title : '' }}</div>
	          			</div>
	          		</div>
	          		<div class="col-12 col-md-3 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				<div class="col-4 d-block d-md-none"><strong>{{ __('admin::lang.title') }}</strong></div>
	          				<div class="col-8 col-md-12">{{ $area->areas_title }}</div>
	          			</div>
	          		</div>
	          		...
	          		<div class="col-12 col-md-2  ">
	          			<div class="row mb-2 mb-md-0">
	          				...
	          				<div class="col-8 col-md-12">
	          					<form method="POST" action="{{ route('admin.areas.destroy', $area->areas_id) }}">
	          						@csrf
	          						@method('DELETE')
									
	          						@can('view areas')
			          					<a href="{{ route('admin.areas.show', $area->areas_id) }}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>
	          						@endcan
	          						@can('update areas')
			          					<a href="{{ route('admin.areas.edit', $area->areas_id) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
	          						@endcan
									@if($area->areas_id != 1)
	          						@can('delete areas')
