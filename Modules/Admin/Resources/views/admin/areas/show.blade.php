...
@section('main')
  <main class="main">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"> <a href="{{ route('admin.areas.index') }}">{{ __('admin::lang.areas') }}</a></li>
      ...
      <div class="animated fadeIn">
        <div class="card">
            ...
            <ul class="list-group">
              <li class="list-group-item">
                <div class="row">
                  ...
                  <div class="col-12 col-md-10">{{ $area->areas_id }}</div>
                </div>
              </li>
              <li class="list-group-item">
                <div class="row">
                  <div class="col-12 col-md-2"><strong>{{ __('admin::lang.title') }}</strong></div>
                  <div class="col-12 col-md-10">{{ $area->areas_title }}</div>
                </div>
              </li>
              ...
              <li class="list-group-item">
                <div class="row">
                  ...
                  <div class="col-12 col-md-10">{{ __('admin::lang.'. $area->areas_status) }}</div>
                </div>
              </li>
            </ul>
          </div>
          <div class="card-footer">
            @can('view areas')
              <a href="{{ route('admin.areas.index') }}" class="btn btn-sm btn-secondary">
                <i class="fa fa-arrow-left"></i>
              </a>
            @endcan
            @can('update areas')
              <a href="{{ route('admin.areas.edit', $area->areas_id) }}" class="btn btn-sm btn-warning">
