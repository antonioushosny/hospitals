    ...
    <div class="container-fluid">
      <div class="animated fadeIn">
        <div class="card">
          ...
          <form class="form-horizontal" action="{{ route('admin.hospitals.update', $hospital->hospitals_id) }}" method="post" enctype="multipart/form-data">
          	@csrf
          	@method('PUT')
          	@include('admin::admin.hospitals.form')
